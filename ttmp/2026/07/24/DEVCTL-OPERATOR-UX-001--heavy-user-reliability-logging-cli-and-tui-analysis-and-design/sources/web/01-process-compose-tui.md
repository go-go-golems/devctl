...
> ![💡](https://cdn.jsdelivr.net/gh/jdecked/twemoji@16.0.1/assets/svg/1f4a1.svg ":bulb:") Using a too large buffer will put more penalty on your CPU.
...
> ![💡](https://cdn.jsdelivr.net/gh/jdecked/twemoji@16.0.1/assets/svg/1f4a1.svg ":bulb:") Too long log lines (above 2^16 bytes long) can cause the log collector to hang.
...
> ![💡](https://cdn.jsdelivr.net/gh/jdecked/twemoji@16.0.1/assets/svg/1f4a1.svg ":bulb:") To apply the new values it's enough to select the `Custom Style` (`F` shortcut) theme from the theme selector menu (`CTRL-T`).
...
> ![💡](https://cdn.jsdelivr.net/gh/jdecked/twemoji@16.0.1/assets/svg/1f4a1.svg ":bulb:") The auto save feature can be disabled by using the `--read-only` flag.
